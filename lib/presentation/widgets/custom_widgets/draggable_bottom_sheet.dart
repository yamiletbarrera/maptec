/*
    Este es un custom widget basado en el paquete draggable_bottom_sheet
    https://pub.dev/packages/draggable_bottom_sheet
    El paquete original no permite colapsar el bottom sheet, 
    cuando uno lo necesite desde cualquier otro lugar, por lo que se modificó.
    Se agregó la propiedad estatica staticCollapsed, que permite ayudarnos con eso.    
 */
...
class DraggableBottomSheet extends StatefulWidget {
  static bool staticCollapsed = false;
...
class DraggableBottomSheetState extends State<DraggableBottomSheet> {
  ...
  Widget _sheet() {
    if (DraggableBottomSheet.staticCollapsed) {
      setState(() {
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        width: DraggableBottomSheet.staticCollapsed
            ? _currentExtent
            : _axis() == Axis.horizontal
                ? _currentExtent
                : null,
        height: DraggableBottomSheet.staticCollapsed
            ? _currentExtent
            : _axis() == Axis.horizontal
                ? null
                : _currentExtent,
        //Se moficio el siguiente código para que el bottom sheet se pueda colapsar segun el valor de staticCollapsed
        /*child: _currentExtent >= widget.minExtent + widget.expansionExtent
            ? widget.expandedWidget
            : widget.previewWidget,*/
        child: DraggableBottomSheet.staticCollapsed
            ? widget.previewWidget
